...
namespace Diplom_v._0._36 {
    ...
    public partial class Diplom2DataSet : global::System.Data.DataSet {
        ...
        public partial class LoadDataTable : global::System.Data.TypedTableBase<LoadRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public LoadRow AddLoadRow(string Teacher, string Subject, bool Lecture, bool Practice, string Groups) {
        ...
        public partial class LoadRow : global::System.Data.DataRow {
            ...
            public string Teacher {
                get {
                    try {
                        return ((string)(this[this.tableLoad.TeacherColumn]));
                    }
            ...
            public string Subject {
                get {
                    try {
                        return ((string)(this[this.tableLoad.SubjectColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace Diplom_v._0._36.Diplom2DataSetTableAdapters {
    ...
    public partial class LoadTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Load` WHERE ((`Key` = ?) AND ((? = 1 AND `Teacher` IS NULL) OR (`Teacher` = ?)) AND ((? = 1 AND `Subject` IS NULL) OR (`Subject` = ?)) AND ((? = 1 AND `Lecture` IS NULL) OR (`Lecture` = ?)) AND ((? = 1 AND `Practice` IS NULL) OR (`Practice` = ?)) AND ((? = 1 AND `Groups` IS NULL) OR (`Groups` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Load` (`Teacher`, `Subject`, `Lecture`, `Practice`, `Groups`) VALUES" +
                " (?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Load` SET `Teacher` = ?, `Subject` = ?, `Lecture` = ?, `Practice` = ?, `Groups` = ? WHERE ((`Key` = ?) AND ((? = 1 AND `Teacher` IS NULL) OR (`Teacher` = ?)) AND ((? = 1 AND `Subject` IS NULL) OR (`Subject` = ?)) AND ((? = 1 AND `Lecture` IS NULL) OR (`Lecture` = ?)) AND ((? = 1 AND `Practice` IS NULL) OR (`Practice` = ?)) AND ((? = 1 AND `Groups` IS NULL) OR (`Groups` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [Key], Teacher, Subject, Lecture, Practice, Groups FROM Load";
        ...
        public virtual int Delete(int Original_Key, string Original_Teacher, string Original_Subject, bool Original_Lecture, bool Original_Practice, string Original_Groups) {
        ...
        public virtual int Insert(string Teacher, string Subject, bool Lecture, bool Practice, string Groups) {
            if ((Teacher == null)) {
        ...
        public virtual int Update(string Teacher, string Subject, bool Lecture, bool Practice, string Groups, int Original_Key, string Original_Teacher, string Original_Subject, bool Original_Lecture, bool Original_Practice, string Original_Groups) {
            if ((Teacher == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[11].Value = ((bool)(Original_Lecture));
            this.Adapter.UpdateCommand.Parameters[12].Value = ((object)(0));
            this.Adapter.UpdateCommand.Parameters[13].Value = ((bool)(Original_Practice));
            if ((Original_Groups == null)) {
